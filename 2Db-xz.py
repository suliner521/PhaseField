...
class calEnergyGradient:
    ...
    def iter(self):
        ...
        Ep, DEpDphi = self._cal_DEpDDdphi(DphiDxAbsInv, nx, nz, DnDphi)
    ...
    def _cal_DEpDDdphi(self, DphiDxAbsInv, nx, nz, DnDphi):
        ...
        DEDn = E0 * np.stack([-ny * K1, K2], axis=0)
